...
public class Inventory_accessories extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public Inventory_accessories(Context context, AppCompatActivity appCompatActivity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_inventory_accessories, container, false);
